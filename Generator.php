...
<p>Nome del Tema: <input type="text" name="themename"></p>
<p>Inserisci il primo colore:<input type="text" name="color1"></p>
<p>Inserisci il secondo colore:<input type="text" name="color2"></p>
...
Tema Generato dal programma Colorize compatibile con la versione 2.4.0 di Ultrapixel coded by Helias

Theme Name: UltraPixel - $themename

Theme URL: http://ultrapixel.altervista.org

Version Generator: 1.00
